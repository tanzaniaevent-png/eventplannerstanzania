...
const GALLERY_IMAGES: GalleryImage[] = [
  ...
  // Tanzania-Egypt Business Forum
  { src: "/images/gallery/tz-egypt-forum-arrival-01.jpg", alt: "Delegate arriving by car at VIP airport terminal for the Tanzania-Egypt Business Forum", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-handshake-01.jpg", alt: "Delegates shaking hands in a hallway lined with Tanzania and Egypt flags on arrival", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-arrival-02.jpg", alt: "Delegation disembarking a VIP shuttle bus with luggage at the airport", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-arrival-03.jpg", alt: "Motorcade of vehicles gathered outside the VIP Terminal II building", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-motorcade-01.jpg", alt: "Motorcycle security escort leading a motorcade of black SUVs", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-gala-dinner-01.jpg", alt: "Guests in conversation at a candlelit gala dinner table strung with fairy lights", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-gala-dinner-02.jpg", alt: "Guests chatting beside the buffet stations at the gala dinner", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-venue-branding-01.jpg", alt: "Wide view of the rooftop gala dinner setup with string lights and red carpet at night", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-handshake-02.jpg", alt: "Handshake between delegates beside a table set with Tanzania and Egypt flags", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-gala-dinner-03.jpg", alt: "Guests smiling at a gold-themed gala dinner table set with Tanzania and Egypt flags", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-venue-branding-02.jpg", alt: "Large LED screen branded with the Tanzania-Egypt Business Forum logo above set banquet tables", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-registration-01.jpg", alt: "Staff organising delegate lanyards at the forum registration desk", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-group-photo-01.jpg", alt: "Five executives posed on stage in front of the Tanzania-Egypt Business Forum backdrop", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-stage-speaker-01.jpg", alt: "Speaker addressing the forum from the podium in front of the branded LED screen", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-stage-speaker-02.jpg", alt: "Female speaker presenting at the podium at the Tanzania-Egypt Business Forum", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-stage-speaker-03.jpg", alt: "Speaker gesturing while addressing delegates from the forum podium", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-audience-01.jpg", alt: "Wide view of delegates seated across the conference hall during the forum", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-networking-01.jpg", alt: "Group of business delegates greeting each other beside a round table", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-presentation-01.jpg", alt: "Executives exchanging a plaque during a presentation ceremony on stage", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-group-photo-02.jpg", alt: "Large group photo of forum delegates posed together on stage", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-panel-discussion-01.jpg", alt: "Panelist speaking into a handheld microphone during a forum discussion", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-panel-discussion-02.jpg", alt: "Moderator holding a microphone in front of a colourful investment infographic screen", category: "Corporate Events" },
  { src: "/images/gallery/tz-egypt-forum-group-photo-03.jpg", alt: "Eight-person panel lineup on stage in front of the full Tanzania-Egypt Business Forum banner", category: "Corporate Events" },
];
